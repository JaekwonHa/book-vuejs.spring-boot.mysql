      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="card-container">
            ...
            <div class="wrapper attachments-wrapper" v-show="attachments.length || uploadingCount">
              <h5>
                ...
                <span>Attachments</span></h5>
              <div class="wrapper-body">
                <div class="uploading" v-show="uploadingCount">
                  <font-awesome-icon icon="spinner" class="fa-spin" spin/>
                  Uploading...
                </div>
          ...
          <div class="card-controls">
            ...
            <div class="control">
              <font-awesome-icon icon="archive" class="icon"/>
              Archive
            </div>
          </div>
        </div>
