...
import com.taskagile.domain.model.activity.*;
...
public class CardServiceImpl implements CardService {
    ...
    public CardServiceImpl(CardRepository cardRepository, CardListRepository cardListRepository, ActivityRepository activityRepository, AttachmentManagement attachmentManagement, AttachmentRepository attachmentRepository, DomainEventPublisher domainEventPublisher) {
