...
public class ApiRequestAccessDeniedExceptionTranslationFilter extends GenericFilterBean {
    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain filterChain) throws IOException, ServletException {
        ...
        try {
            ...
            // This is not a Spring Security's AccessDeniedException. We do not need to precess it here
            if (ase == null) {
                throw ex;
            }
            ...
            // The user is not authenticated. Instead of showing a 403 error, we should send a 401 error to the client, indicating that accessing the requested
